/**
 * PLACEHOLDER — W3 — Auth: passkey / recovery / session / email-OTP / bootstrap ceremonies
 * (AUTH.md, API.md §2). Mounted first in the router because the auth surface is
 * the one an anonymous client can reach before anything else exists.
 *
